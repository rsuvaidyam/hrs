...
<template>
	<div class="h-screen mx-auto max-w-[1800px]" v-motion :initial="{ opacity: 0, scale: 0.8 }"
		...
		<div v-else class=" pb-20 w-full h-full px-0 lg:px-4 bg-gray-100 relative">
			...
			<div class="fixed w-full left-0 h-12 flex px-2 md:px-16 bg-white items-center z-50 bottom-1 ">
				<div class="flex w-full  justify-between items-center">
					...
					<div @click="placeOrder()" class="text-white cursor-pointer rounded-sm bg-primary py-1 px-8">PLACE
						ORDER
					</div>
				</div>
			</div>
